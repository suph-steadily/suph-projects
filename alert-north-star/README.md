...
- **Bind rates, measured on one window (Jan to May 2026, quotes that actually got rated):** the age-alert lane binds at 15.7%. Clean homes under 91 with zero alerts bind at 18.0%, and that is the standard no-alert rate. But old homes with no alerts do NOT reach it: 91 to 100 year old homes with zero alerts bind at 13.7%, lower than the alerted lane. Age itself costs binds before any alert does, so there is no honest "lift old homes to 18%" bracket. The +115 rests on the funnel: recovering a slice of the 63 per 100 who die at the roadblock without ever being referred. Its range stays +50 to +175.
